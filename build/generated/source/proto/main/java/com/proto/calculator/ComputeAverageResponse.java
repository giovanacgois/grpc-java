...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 9: {
            ...
            averageComputed_ = input.readDouble();
            break;
          }
          default: {
  ...
  public static final int AVERAGE_COMPUTED_FIELD_NUMBER = 1;
  private double averageComputed_;
  /**
   * <code>double average_computed = 1;</code>
   * @return The averageComputed.
   */
  @java.lang.Override
  public double getAverageComputed() {
    return averageComputed_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (averageComputed_ != 0D) {
      output.writeDouble(1, averageComputed_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (averageComputed_ != 0D) {
      size += com.google.protobuf.CodedOutputStream
        .computeDoubleSize(1, averageComputed_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (java.lang.Double.doubleToLongBits(getAverageComputed())
        != java.lang.Double.doubleToLongBits(
            other.getAverageComputed())) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + AVERAGE_COMPUTED_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
        java.lang.Double.doubleToLongBits(getAverageComputed()));
  ...
  public static final class Builder extends
    ...
    public com.proto.calculator.ComputeAverageResponse buildPartial() {
      ...
      result.averageComputed_ = averageComputed_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.proto.calculator.ComputeAverageResponse other) {
      ...
      if (other.getAverageComputed() != 0D) {
        setAverageComputed(other.getAverageComputed());
      }
    ...
    /**
     * <code>double average_computed = 1;</code>
     * @param value The averageComputed to set.
     * @return This builder for chaining.
     */
    public Builder setAverageComputed(double value) {
      
      averageComputed_ = value;
      onChanged();
      return this;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder clearAverageComputed() {
